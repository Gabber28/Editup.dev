...
describe("EditorShell responsive modes", () => {
  ...
  // The source snippet is a tab inside the Inspector now, not a shell slot —
  // its visibility is covered by editor.tabs.test.tsx.
  it("renders the inspector in every mode", () => {
